...
public class Upload_right {
	...
	JFrame f1;
	 ...
	 Upload_right(String fname)
	  ...
	  l1 = new JLabel("Upload Right Eye Image");
...
private void b1MouseClicked(java.awt.event.MouseEvent evt) throws Exception {
	  ...
	  long right_eyen = System.currentTimeMillis();
	  File new_file=new File("F:\\BE Project\\Python Model\\trimmed\\"+right_eyen+".jpeg");
	  
	  if(file.renameTo(new_file))
	  {
		 String final_right=Long.toString(right_eyen);
		 final_right=final_right+".jpeg";
		 
		 String query="update login set right_eye='"+final_right+"' where id='"+id+"'";
